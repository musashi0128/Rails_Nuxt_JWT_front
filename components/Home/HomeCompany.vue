...
export default {
  data () {
    const twitter = 'https://www.google.com/?hl=ja'
    const slack = 'https://www.google.com/?hl=ja'
    const companyUrl = 'https://www.google.com/?hl=ja'
    return {
      members: [
        { name: '代表', position: '代表取締役', img: member1, twitter, slack },
        { name: 'エンジニア', position: 'エンジニア', img: member2 },
        { name: 'デザイナー', position: 'デザイナー', img: member3 }
      ],
      infomations: [
